...
class AboutCtrl: UIViewController {
    ...
    let debPath = "/var/mobile/Media/iMemScan(Script)/iMemScan.deb"
    ...
    lazy var bottomLabel: UILabel = {
        ...
        label.text = "Copyright © 2022 Summit. All Rights Reserved."
        return label
    }()
}
...
//        }
    ...
    func remove_deb(_ tableView: UITableView?, index indexPath: IndexPath?) {
        ...
        alertCtrl.addAction(UIAlertAction(title: "确定卸载", style: .destructive, handler: { action in
            runCmd(path: "/usr/bin/dpkg", args: ["--remove", "com.yiming.iMemScan"])
