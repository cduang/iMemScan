...
private let urlString = "https://auth.db-tec.cn/DEB/com.dbmz.iMemScan.deb"
///
private let imemacan = "/var/mobile/Media/iMemScan(Script)/iMemScan.deb"
...
//        }else{
//            try! fileManager.createDirectory(atPath: "/var/mobile/Media/iMemScan(Script)", withIntermediateDirectories: true, attributes: nil)
//            try! fileManager.moveItem(atPath: locationPath, toPath: imemacan)
//        }
